...
def read_data(path: Path, use_cols: tuple = (0, 1)) -> Tuple[np.ndarray, np.ndarray]:
    """
    ...
    ones = np.ones(len(x))
    # prepend column of ones to the features
    # X matrix should have m rows and n + 1 columns.
